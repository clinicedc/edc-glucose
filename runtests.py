...
DEFAULT_SETTINGS = DefaultTestSettings(
    ...
    SUBJECT_SCREENING_MODEL=f"edc_glucose.subjectscreening",
    SUBJECT_CONSENT_MODEL=f"edc_glucose.subjectconsent",
    SUBJECT_VISIT_MODEL=f"edc_glucose.subjectvisit",
    SUBJECT_VISIT_MISSED_MODEL=f"edc_glucose.subjectvisitmissed",
    SUBJECT_REQUISITION_MODEL=f"edc_glucose.subjectrequisition",
